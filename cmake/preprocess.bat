...
@set FB_BIN_DIR=..\bin
@set FB_GEN_DIR=..\gen
@set FB_GEN_DB_DIR=../gen
@if not defined FB_ROOT_PATH (set FB_ROOT_PATH=..)
...
@echo copied: move %FB_GEN_DIR%\preprocessing.cpp %FB_GEN_DIR%\%1\%2.cpp
...
::===========
:GPRE_M
::@echo run: %GPRE% -n -m %FB_ROOT_PATH%\src\%1\%2.epp %FB_GEN_DIR%\preprocessing.cpp -b %FB_GEN_DB_DIR%/dbs/
